...
namespace Eco.Mods.TechTree			// added
{
	using System;
	using System.Collections.Generic;
	using System.ComponentModel;
    using Eco.Core.Items;			// added
    ...
    [Serialized]
    [LocDisplayName("Tractor Whetstone")]
    [Weight(500)]
    [MaxStackSize(50)]
    [Currency]
    [Category("Tool")]
    [Tag("Tool", 1)]
    [Ecopedia("Items", "Tools", createAsSubPage: true)]
    public class TractorWhetstoneItem : Whetstone
    {
        protected override Type RepairItem => typeof(IronPlateItem);
        public override LocString DisplayDescription => Localizer.DoStr("Consume to repair tractor attachment");
    }

    [RequiresSkill(typeof(BasicEngineeringSkill), 0)]
    [Ecopedia("Items", "Tools", subPageName: "Wood Whetstone Item")]
    ...
    [RequiresSkill(typeof(BasicEngineeringSkill), 0)]
    [Ecopedia("Items", "Tools", subPageName: "Stone Whetstone Item")]
    ...
    [Ecopedia("Items", "Tools", subPageName: "Iron Whetstone Item")]
    ...
    [Ecopedia("Items", "Tools", subPageName: "Steel Whetstone Item")]
    ...
    [Ecopedia("Items", "Tools", subPageName: "Tractor Whetstone Item")]
    public class TractorWhetstoneRecipe : RecipeFamily
    {
        public TractorWhetstoneRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                "Tractor Whetstone",
                Localizer.DoStr("Tractor Whetstone"),
                new List<IngredientElement>
                {
                ...
                new List<CraftingElement>
                {
                    new CraftingElement<TractorWhetstoneItem>()
                });
            Recipes = new List<Recipe> { recipe };
            ExperienceOnCraft = 5;
            LaborInCalories = CreateLaborInCaloriesValue(200, typeof(MechanicsSkill));
            CraftMinutes = CreateCraftTimeValue(
                typeof(TractorWhetstoneItem),
                Whetstone.CraftTime,
                typeof(MechanicsSkill),
                typeof(MechanicsFocusedSpeedTalent),
                typeof(MechanicsParallelSpeedTalent));
            Initialize(Localizer.DoStr("Tractor Whetstone"), typeof(TractorWhetstoneRecipe));
